        ...
        return (
            <div className="d-flex justify-content-center my-4">
                <div className="container mt-4">
                    ...
                    <p>Our library provides free cases and laws concerned about some popular topics.</p>
                    <div className="d-flex justify-content-center my-4">
                        <Link to="/library" className="btn btn-primary custom-btn"> {/* Use Link instead of a */}
                            Library
