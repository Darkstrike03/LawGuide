...
class NCard1 extends React.Component {
    render() {
        return (
            <div>
                <div className="d-flex justify-content-right ps-5 ms-5">
                    <div className="card text-right" style={{ width: '50rem' }}>
                ...
                {/* Another Card */}
                <div className="d-flex justify-content-right ps-5 ms-5 mt-4">
                    <div className="card text-right" style={{ width: '50rem' }}>
                        <div className="card border-0 shadow-lg">
                            <div className="card-header">
                                Another Notice
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Another special title treatment</h5>
                                <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                <a href="#" className="btn btn-primary custom-btn">
                                    Learn more
                                    <svg fill="#ffffff" height="24px" width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
