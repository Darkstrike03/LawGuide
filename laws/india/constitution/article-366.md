...
tags: ["constitutional", "constitution"]
last_amended: 1950
status: "active"
short_description: "Definitions — a provision under Miscellaneous of the Constitution of India."
---
...
This article provides specific definitions for various terms used within the Constitution, such as what is meant by agricultural income, an Anglo-Indian, and different types of financial obligations like 'debt' and 'estate duty'. These definitions ensure that when the Constitution is applied in laws and regulations, everyone understands the exact meaning of these legal terms.

### Key Points
*   **Agricultural Income:** This term is defined according to the rules set by Indian income-tax laws.
*   **Anglo-Indian:** This defines a specific category of person based on the descent of their father or male ancestors from European origin, provided they meet certain residency and birth criteria in India.
*   **Corporation Tax:** This defines when a tax on company income is considered 'corporation tax', specifically excluding taxes on agricultural income and ensuring no double taxation issues with dividend income.
*   **Debt and Estate Duty:** These terms are defined to cover liabilities related to repaying capital sums (debt) and duties assessed on property passing upon death (estate duty).

### Why It Matters
These definitions are crucial because they provide a clear, consistent legal framework for interpreting constitutional provisions in financial, taxation, and property matters across India.

### Landmark Judgements
*No major landmark judgements.*

### Related Articles
- [Article 12 — Definitions](/laws/india/constitution/article-12)
- [Article 300A — Constitutional Amendment](/laws/india/constitution/article-300a)
