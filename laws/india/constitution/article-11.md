...
tags: ["constitutional", "citizenship", "parliament", "constitution"]
last_amended: 1950
status: "active"
short_description: "Parliament to regulate the right of citizenship by law — a provision under Citizenship of the Constitution of India."
---
...
### Key Points
*   Parliament holds the ultimate authority to make laws regarding citizenship.
*   These laws cover both gaining citizenship and losing it.
*   This power allows the government to define the criteria for citizenship.
*   Other provisions in the Constitution must follow the rules set by Parliament concerning citizenship.

### Why It Matters
This article establishes that citizenship is not a matter decided arbitrarily but is governed by specific, enacted laws made by the Parliament, ensuring a clear legal framework for national identity.
